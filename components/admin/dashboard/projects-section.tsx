...
export function AdminProjectsSection({
  ...
  onChange: (
    id: string,
    updater: (current: AdminProjectRecord) => AdminProjectRecord,
  ) => void;
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
                  ...
                  onChange={(event) =>
                    onChange(project.id, (current) => ({
                      ...
                      category: event.target
                        .value as AdminProjectRecord["category"],
                    }))
                  }
              ...
              <div className={panelCardClassName}>
                <span className={labelClassName}>Upload Project Image</span>
                <FileUploadControl
                  accept="image/*"
              ...
              <label>
                ...
                <textarea
                  ...
                  onChange={(event) =>
                    onChange(project.id, (current) => ({
                      ...current,
                      tech: parseLines(event.target.value),
                    }))
                  }
                  className={textareaClassName}
                />
