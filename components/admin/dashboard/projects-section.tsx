                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <label>
                                ...
                                <select
                                    ...
                                    onChange={(event) =>
                                        onChange(project.id, (current) => ({
                                            ...current,
                                            category: event.target.value as AdminProjectRecord["category"],
                                        }))
                                    }
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(event) =>
                                        onChange(project.id, (current) => ({ ...current, sortOrder: Number(event.target.value) }))
                                    }
                                    className={fieldClassName}
                                />
                            </label>
                            ...
                            <label className="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    onChange={(event) =>
                                        onChange(project.id, (current) => ({ ...current, description: event.target.value }))
                                    }
                            ...
                            <label>
                                ...
                                <textarea
                                    ...
                                    onChange={(event) =>
                                        onChange(project.id, (current) => ({ ...current, tech: parseLines(event.target.value) }))
                                    }
                                    className={textareaClassName}
                                />
                            </label>
                            <label>
                                ...
                                <textarea
                                    ...
                                    onChange={(event) =>
                                        onChange(project.id, (current) => ({ ...current, features: parseLines(event.target.value) }))
                                    }
                                    className={textareaClassName}
                                />
                            </label>
